...
public class productModel {
  String productName,description,productImage,productPrice,discount, description_details,selection;
    ...
    public productModel(String productName, String description, String productImage, String productPrice,
                        String discount, String description_details, String selection) {
